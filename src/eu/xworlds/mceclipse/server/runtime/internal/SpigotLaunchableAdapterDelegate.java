 ...
 *
 */
public class SpigotLaunchableAdapterDelegate extends LaunchableAdapterDelegate
{
    ...
    public Object getLaunchable(IServer server, IModuleArtifact moduleObject) throws CoreException
    {
        if (server.getAdapter(SpigotServer.class) == null)
            return null;
        if (!(moduleObject instanceof SpigotPlugin) &&
            !(moduleObject instanceof SpigotLibrary))
            return null;
        // TODO
