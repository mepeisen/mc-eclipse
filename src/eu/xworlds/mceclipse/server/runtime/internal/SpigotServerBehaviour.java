 ...
 *
 */
public class SpigotServerBehaviour extends ServerBehaviourDelegate
{
    
    private static final String ATTR_STOP = "stop-server";
    
    protected transient SpigotPingThread ping = null;
    ...
    {
        return getSpigotServer().getSpigotVersionHandler();
    }
    
    public SpigotConfiguration getSpigotConfiguration() throws CoreException
    {
        return getSpigotServer().getSpigotConfiguration();
    }
    ...
    {
        return getSpigotServer().getRuntimeBaseDirectory();
    }
    ...
    protected void publishServer(int kind, IProgressMonitor monitor) throws CoreException
    {
        ...
        IStatus status = getSpigotVersionHandler().prepareRuntimeDirectory(confDir);
        if (status != null && !status.isOK())
            throw new CoreException(status);
        status = getSpigotVersionHandler().prepareDeployDirectory(getServerDeployDirectory());
        if (status != null && !status.isOK())
            throw new CoreException(status);
...
//        if (getSpigotServer().isTestEnvironment())
//            return;
//        
...
//        if (deltaKind == REMOVED || getSpigotServer().isServeModulesWithoutPublish())
//        {
...
//                catch (Exception e)
//                {
//                    throw new CoreException(new Status(IStatus.WARNING, SpigotPlugin.PLUGIN_ID, 0, NLS.bind(Messages.errorPublishCouldNotRemoveModule, module[0].getName()), e));
//                }
...
//            catch (Exception e)
//            {
//                throw new CoreException(new Status(IStatus.WARNING, SpigotPlugin.PLUGIN_ID, 0, "Could not remove module", e));
//            }
//        }
//        else
//        {
...
//            catch (Exception e)
//            {
//                throw new CoreException(new Status(IStatus.WARNING, SpigotPlugin.PLUGIN_ID, 0, "Could not remove archive module", e));
//            }
//        }
//        else
//        {
...
//    }
    ...
    public void setupLaunch(ILaunch launch, String launchMode, IProgressMonitor monitor) throws CoreException
    {
        ...
        IStatus status = getSpigotRuntime().validate();
        if (status != null && status.getSeverity() == IStatus.ERROR)
            throw new CoreException(status);
        
        // setRestartNeeded(false);
        SpigotConfiguration configuration = getSpigotConfiguration();
        
        // check that ports are free
        final ServerPort sp = configuration.getServerPort();
        if (sp.getPort() < 0)
            throw new CoreException(new Status(IStatus.ERROR, McEclipsePlugin.PLUGIN_ID, "invalid port"));
        if (SocketUtil.isPortInUse(sp.getPort(), 5))
        {
            throw new CoreException(new Status(IStatus.ERROR, McEclipsePlugin.PLUGIN_ID, "port in use"));
        }
...
//            Trace.trace(Trace.SEVERE, "Error killing the process", e);
    ...
    {
        String originalArg = origArg == null ? "" : origArg;
        if (vmArgs == null)
            return originalArg;
    ...
    public void setupLaunchConfiguration(ILaunchConfigurationWorkingCopy workingCopy, IProgressMonitor monitor) throws CoreException
    {
        ...
        ISpigotRuntime runtime = getSpigotRuntime();
...
//    /**
//     * Cleans the entire work directory for this server. This involves deleting all subdirectories of the server's work directory.
//     * 
//     * @param monitor
//     *            a progress monitor
...
//        IPath workPath = getSpigotConfiguration().getServerWorkDirectory(basePath);
//        if (workPath != null)
//        {
...
//                {
//                    MultiStatus ms = new MultiStatus(SpigotPlugin.PLUGIN_ID, 0, "Problem occurred deleting work directory for module.", null);
...
//        else
//        {
//            result = new Status(IStatus.ERROR, SpigotPlugin.PLUGIN_ID, 0, "Could not determine work directory for module", null);
//        }
//        return result;
//    }
...
//     * 
//     * @param module
//     *            module whose work directory should be cleaned
//     * @param monitor
//     *            a progress monitor
//     * @return result of the clean operation
//     * @throws CoreException
//     */
//    public IStatus cleanContextWorkDir(ISpigotWebModule module, IProgressMonitor monitor) throws CoreException
//    {
//        IStatus result;
//        IPath basePath = getRuntimeBaseDirectory();
//        IPath workPath = getSpigotConfiguration().getContextWorkDirectory(basePath, module);
//        if (workPath != null)
//        {
//            File workDir = workPath.toFile();
//            result = Status.OK_STATUS;
...
//    }
    ...
    {
        return getSpigotServer().getRuntimeBaseDirectory().append(this.getServerDeployDirectory());
    }
...
//            p.store(fout, "Spigot publish data");
//        }
//        catch (Exception e)
//        {
//            // ignore
...
//    public void setSpigotServerPublishState(int state)
//    {
//        setServerPublishState(state);
//    }
    
//    public void setSpigotServerRestartState(boolean state)
//    {
