...
public abstract class AbstractLaunchConfigurationDelegate extends AbstractJavaLaunchConfigurationDelegate
{
    ...
    /**
     * Returns the server behaviour.
     * @param server
     * @return behaviour.
     */
    protected abstract AbstractServerBehaviour getServerBehaviour(IServer server);
    ...
    public void launch(ILaunchConfiguration configuration, String mode, ILaunch launch, IProgressMonitor monitor) throws CoreException
    {
        ...
        final AbstractServerBehaviour serverBehaviour = this.getServerBehaviour(server);
        final String mainTypeName = serverBehaviour.getRuntimeClass();
