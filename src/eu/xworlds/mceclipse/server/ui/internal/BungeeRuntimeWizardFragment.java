 ...
 *
 */
public class BungeeRuntimeWizardFragment extends WizardFragment
{
    /**
     * 
     */
    protected BungeeRuntimeComposite comp;
    
    /**
     * 
     */
    public BungeeRuntimeWizardFragment()
    {
        // do nothing
    }
    ...
    {
        this.comp = new BungeeRuntimeComposite(parent, wizard);
        return this.comp;
    }
