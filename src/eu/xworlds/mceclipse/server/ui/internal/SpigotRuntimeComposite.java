 ...
 *
 */
public class SpigotRuntimeComposite  extends Composite {
    protected IRuntimeWorkingCopy runtimeWC;
    protected ISpigotRuntimeWorkingCopy runtime;
    ...
    protected void setRuntime(IRuntimeWorkingCopy newRuntime) {
        if (newRuntime == null) {
            ...
            runtime = (ISpigotRuntimeWorkingCopy) newRuntime.loadAdapter(ISpigotRuntimeWorkingCopy.class, null);
        }
    ...
    protected void createControl() {
        ...
        label.setText("Spigot installation &directory:");
        data = new GridData();
        data.horizontalSpan = 2;
        label.setLayoutData(data);
        ...
        browse.addSelectionListener(new SelectionAdapter() {
            public void widgetSelected(SelectionEvent se) {
                DirectoryDialog dialog = new DirectoryDialog(SpigotRuntimeComposite.this.getShell());
                dialog.setMessage("Select Spigot installation directory.");
        ...
        install = SWTUtil.createButton(this, "Download and Install...");
        install.setEnabled(false);
...
//                  ir.install(new Path(selectedDirectory));
    ...
    protected void updateJREs() {
        ...
        jreNames[0] = "Workbench default JRE";
        for (int i = 0; i < size; i++) {
