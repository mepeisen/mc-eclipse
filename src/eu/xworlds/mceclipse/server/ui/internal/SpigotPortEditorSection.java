...
import eu.xworlds.mceclipse.server.runtime.internal.SpigotConfiguration;
 ...
 *
 */
public class SpigotPortEditorSection extends ServerEditorSection {
    protected SpigotConfiguration spigotConfiguration;
     ...
     */
    public SpigotPortEditorSection() {
        super();
    }
    ...
    protected void addChangeListener() {
        listener = new PropertyChangeListener() {
            public void propertyChange(PropertyChangeEvent event) {
                if (SpigotConfiguration.MODIFY_PORT_PROPERTY.equals(event.getPropertyName())) {
        ...
        spigotConfiguration.addPropertyChangeListener(listener);
    }
...
//        whs.setHelp(ports, ContextIds.CONFIGURATION_EDITOR_PORTS_LIST);
        ...
        ICellModifier cellModifier = new ICellModifier() {
            ...
            public void modify(Object element, String property, Object value) {
                try {
                    ...
                    execute(new ModifyPortCommand(spigotConfiguration, sp.getId(), port));
                } catch (Exception ex) {
                    // ignore
                }
            }
    ...
    public void dispose() {
        if (spigotConfiguration != null)
            spigotConfiguration.removePropertyChangeListener(listener);
    }
    ...
    public void init(IEditorSite site, IEditorInput input) {
        ...
        SpigotServer ts = (SpigotServer) server.getAdapter(SpigotServer.class);
        try {
            spigotConfiguration = ts.getSpigotConfiguration();
        } catch (Exception e) {
            // ignore
        }
        addChangeListener();
    ...
    protected void initialize() {
        ...
        ServerPort port = spigotConfiguration.getServerPort();
